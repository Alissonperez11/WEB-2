...
for(const iterator of Resultado) {
    auxPaciente= Paciente.find(paci=> paci.id===iterator.idpaciente)
    auxTipo= Tipo_Examen.find(tip=> tip.id===iterator.idtipo_examen)
    console.log(`\n*** INGRESO DE Resultados ***:
    \tNombrePaciente: ${auxPaciente.Nombre} 
    \tidentificacion: ${auxPaciente.Cedula}
    \tDescripcion:${auxTipo.Descripcion}
    \tIndicaciones: ${auxTipo.Indicaciones} 
    \tResultados: ${iterator.Resultado_examen}`);
